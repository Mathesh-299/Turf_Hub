...
const AdminDashboard = () => {
    ...
    return (
        <div className="min-h-screen pt-24 px-4 pb-16 bg-gradient-to-br from-gray-100 to-green-50">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-6">
                    ...
                    <div className="bg-white p-4 rounded-xl shadow">
                        <h2 className="text-sm text-gray-600">Total Slots</h2>
                        <p className="text-2xl font-semibold text-green-700">{totalSlots}</p>
                    </div>
                    <div className="bg-white p-4 rounded-xl shadow">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredTurfs.map((turf) => (
                            <div key={turf._id} className="bg-white p-4 rounded-xl shadow-md">
                                ...
                                />
                                <h2 className="text-lg font-semibold text-green-800">{turf.name}</h2>
